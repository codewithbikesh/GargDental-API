              ...
              <form method="post" action="{{ route('backend.profile.update') }}" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <img src="{{ Auth::user()->image_full_url }}" alt="Profile" width="100">
                    <div class="pt-2">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="name" type="text" class="form-control" id="fullName" value="{{ $admin_user->name }}">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="country" type="text" class="form-control" id="Country" value="{{ $admin_user->country }}">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="address" type="text" class="form-control" id="Address" value="{{ $admin_user->address }}">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="phone" type="text" class="form-control" id="Phone" value="{{ $admin_user->phone }}">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="email" type="email" class="form-control" id="Email" value="{{ $admin_user->email }}">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <select class="form-select" name="account_type" aria-label="Account Type">
                      <option value="A" {{ $admin_user->account_type == 'A' ? 'selected' : '' }}>Admin</option>
                      <option value="U" {{ $admin_user->account_type == 'U' ? 'selected' : '' }}>Normal User</option>
                    </select>
                  </div>
                </div>
